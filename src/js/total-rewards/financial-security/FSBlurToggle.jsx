...
import { useGetInvestmentsDataQuery } from '../../dux/totalRewardsApi.js';
 ...
 *  - toggle ui
 */
export const FSBlurToggle = ({ cookName }) => {
  const { refetch } = useGetInvestmentsDataQuery('vanguard');
  ...
  connectedCallback() {
    ...
    root.render(
      <Provider store={store}>
        <FSBlurToggle cookName={this.cookName} />
      </Provider>
    );
  }
}

registerCustomElement('total-rewards-fs-blur-toggle', BlurToggleClass);
